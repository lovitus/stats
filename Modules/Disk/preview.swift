...
internal class Preview: PreviewWrapper {
    ...
    private func historyView() -> NSView {
        ...
        let chart = NetworkChartView(frame: .zero, num: lineChartSamples(forHistory: lineChartDefaultHistory), historyKey: lineChartHistoryKey(self.module.stringValue, "activity"))
        self.chart = chart
